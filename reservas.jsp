        ...
        <div class="about">
            <div class="container">
             <div style="float: right; width: 1140px;">
                    <a href="ayudas/ayuda_reservas.jsp"><img src="img/btn_ayuda.png" height="40" width="110" alt=""></a>
                ...
                <div align="left" id="reservar_modulo">
                    ...
                    <br>
                    <br>
                    <form method="POST" action="reservas.jsp" name="fecha">
                        <div style='float: left;'>
                                 
                            Entrada:<br>
                            mm/dd/aaaa
                            <input type="text"  id='from' name="entrada"  required/>
                           <br>
                            <br>
                            Salida:<br>
                            mm/dd/aaaa
                ...
                <div id="centro">
                    ...
                    <%                        if (request.getParameter("buscar_h") != null) {
                            ...
                            if (pers1 > 0) {
                                ...
                                String consulta = "";
                                consulta = "select cod_habitacion, tipo_habitaciones.tipo_hab, ubicacion, precio, foto, n_personas from habitaciones, tipo_habitaciones where habitaciones.tipo_hab=tipo_habitaciones.cod_hab and n_personas='" + pers1 + "' order by cod_habitacion asc";
                            ...
                            if (pers2 > 0) {
                                ...
                                String consulta = "";
                                consulta = "select cod_habitacion, tipo_habitaciones.tipo_hab, ubicacion, precio, foto, n_personas from habitaciones, tipo_habitaciones where habitaciones.tipo_hab=tipo_habitaciones.cod_hab and n_personas='" + pers2 + "' order by cod_habitacion asc";
                                ResultSet rs1 = con.consulta(consulta);
                                int contador = 0;
                                while (rs1.next()) {
                                    contador++;
                            ...
                            if (pers3 > 0) {
                                ...
                                String consulta = "";
                                consulta = "select cod_habitacion, tipo_habitaciones.tipo_hab, ubicacion, precio, foto, n_personas from habitaciones, tipo_habitaciones where habitaciones.tipo_hab=tipo_habitaciones.cod_hab and n_personas='" + pers3 + "' order by cod_habitacion asc";
                                ResultSet rs1 = con.consulta(consulta);
                                int contador = 0;
                                while (rs1.next()) {
                                    contador++;
                ...
                <div align="center" id="configurar">
                    ...
                    <form  id="logina" name="logina" action="reservas.jsp" method="GET">
                        ...
                        <button type="submit" class="btn btn-default btn-green" id="buscar" name="loggar">LOGGIN</button>
                    </form> 
                    <br>
                    No tienes cuenta?: <a href="ncliente.jsp">Registrate</a>
                    <%
                        //CODIGO DE ACCESO
                        if (request.getParameter("loggar") != null) {
                            int b = 0;
