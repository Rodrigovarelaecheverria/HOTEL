        ...
        <div class="about">
            <div class="container">
                 <div style="float: right; width: 1140px;">
                    <a href="ayudas/noticias_listar.jsp"><img src="img/btn_ayuda.png" height="40" width="110" alt=""></a>
                    <a href="javascript:history.back()"><img src="img/btn_atras.png" height="40" width="110" alt=""></a>  
                </div>
                <div class="about-top heading">
                    <h2 class="tittle-one">Administrar Noticias</h2>
                </div>
                ...
                <div id="centro">
                    ...
                    <%
                        if (request.getParameter("enviar") != null) {
                            ...
                            rs = con.consulta("select * from noticias where  (fecha>='" + inicio + "' and fecha<='" + fin + "')");
                            out.print("<table width='100%' border='1'>");
                            out.print(" <tbody>");
                            out.print("<tr>");
                            out.print("<td>N°</td>");
                            out.print("<td>Título</td>");
                            out.print(" <td>Autor</td>");
                            out.print(" <td>Fecha</td>");
                            out.print(" <td>Estado</td>");
                            out.print(" <td>Acciones</td>");
                            out.print(" </tr>");
                            while (rs.next()) {

                                out.print("<tr>");
                                out.print("<td>" + rs.getString("id_noticia") + "</td>");
                                out.print("<td>" + rs.getString("titulo") + "</td>");
                                out.print(" <td>" + rs.getString("autor") + "</td>");
                                out.print(" <td>" + rs.getString("fecha") + "</td>");
                                
                                
                                if (rs.getString("estado").endsWith("t")) {
                                    out.print(" <td>Publicada</td>");
                                } else {
                                    out.print(" <td>Suspendida</td>");
                                }
                                out.print(" <td><a href=./procesos/anoticia.jsp?id=" + rs.getString("id_noticia") + "><img src=./img/activar.png width=30px height=30px></a>"
                                        + " <a href=./procesos/enoticia.jsp?id=" + rs.getString("id_noticia") + "><img src=./img/eliminar.png width=30px height=30px></a></td>");
                        ...
                        rs = con.consulta("select * from noticias ");
                            out.print("<table width='100%' border='1'>");
                            out.print(" <tbody>");
                            out.print("<tr>");
                            out.print("<td>N°</td>");
