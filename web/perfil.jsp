        ...
        <div class="about">
            <div class="container">
                  <div style="float: right; width: 1140px;">
                    <a href="ayudas/ayuda_perfil.jsp"><img src="img/btn_ayuda.png" height="40" width="110" alt=""></a>
                ...
                <div id="centro">
                    <h3 class="tittle-one">ACTUALIZAR PERFIL</h3>
                    <br>
                    <br>
                    ...
                    <div>
                        <%
                            ...
                            while (rs.next()) {
                                out.print("<form  id='registro' name='registro' action='perfil.jsp?id=" + rs.getString("dni") + "' method='POST'>");
                                ...
                                out.print("   </div>");
                                out.print("  <div class='form-group'>");
                                out.print("      <input type='email' disabled class='form-control' id='correo' name='correo' placeholder='Ingrese su correo electronico' onchange='validare(registro);' value='" + rs.getString("correo") + "'>");
                                out.print("   </div>");
                                out.print("   <div class='form-group'>");
                ...
                <div align="center" id="configurar">
                    ...
                    <form  id="logina" name="logina" action="perfil.jsp" method="GET">
