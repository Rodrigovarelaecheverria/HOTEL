...
<html>
        ...
        <div class="about">
            <div class="container">
                 <div style="float: right; width: 1140px;">
                    <a href="../ayudas/ayuda_servicios.jsp"><img src="../img/btn_ayuda.png" height="40" width="110" alt=""></a>
    ...
    <div class="about-top heading">
                    ...
                    <h2 class="tittle-one">Ofrecemos</h2>
                    <div class="welcome-grids">
                        <div class="col-md-4 welcome-left">
                            <ul>
                                <li><a href="#">Cuenta con 30 habitaciones con banos privados.</a></li>
                                <li><a href="#">Television por cable.</a></li>
                                <li><a href="#">Servicio de WIFI.</a></li>
                            </ul>
                        </div>
                        <div class="col-md-4 welcome-middle">
                            <ul>
                                <li><a href="#">Amplio parqueadero.</a></li>
                                <li><a href="#">Piscinas temperadas y cubierta.</a></li>
                                <li><a href="#">Turco e hidromasaje.</a></li>
                            </ul>
                        </div>
                        <div class="col-md-4 welcome-right">
                            <ul>
                                <li><a href="#">Servicio personalizado.</a></li>
                                <li><a href="#">Personal de confianza y capacitado.</a></li>
                                <li><a href="#">Tarifas especiales para grupos.</a></li>
                            </ul>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    ...
                    <%
                        ...
                        if (request.getParameter("buscar") != null) {
                            ...
                            if (b == 1) {
                                ...
                                out.println("<script language='javascript'>window.location='servicios.jsp'</script>;");
