        ...
        <div class="about">
            <div class="container">
                <div style="float: right; width: 1140px;">
                    <a href="../ayudas/ayuda_acercade.jsp"><img src="../img/btn_ayuda.png" height="40" width="110" alt=""></a>
                ...
                <div align="left" id="reservar">
                    <br>
                    <h2 class="tittle-one">Registrate para reservar</h2>
                ...
                <div id="centro">
                    ...
                    <div id="tarjeta">
                        <h2 align="center">Alexis Márquez</h2>
                        <br>
                        <table width=100%>
                            <tr>
                                <td align="center" width=40%>
                                    <img  src="../img/alexis.jpg" class="img-circle" width="110">
                                </td>
                                <td>
                                    <div id="tarjeta_dentro">
                                        <h4 align="center">Sistemas Uniandes-Ibarra</h4>
                                    </div><br>
                                    <div id="tarjeta_dentro">
                                        <h4 align="center">alxozgott@gmail.com</h4>
                                    </div><br>
                                    <div id="tarjeta_dentro">
                                        <h4 align="center">0992957700</h4>
                                    </div>
                                </td>
                            </tr>
                        </table>
                    ...
                    <div id="tarjeta">
                        <h2 align="center">Christian Suárez</h2>
                        <br>
                        <table width=100%>
                            <tr>
                                <td align="center" width=40%>
                                    <img  src="../img/chris.png" class="img-circle" width="95">
                                </td>
                                <td>
                                    <div id="tarjeta_dentro">
                                        <h4 align="center">Sistemas Uniandes-Ibarra</h4>
                                    ...
                                    <div id="tarjeta_dentro">
                                        <h4 align="center">suarezchristian2009@gmail.com</h4>
                                    </div><br>
                                    <div id="tarjeta_dentro">
                                        <h4 align="center">0983602714</h4>
                                    </div>
                                </td>
                            </tr>
                        </table>
                    ...
                    <div id="tarjeta">
                        <h2 align="center">Rodrigo Varela</h2>
                        <br>
                        <table width=100%>
                            <tr>
                                <td align="center" width=40%>
                                    <img  src="../img/rodry.jpg" class="img-circle" width="110">
                                </td>
                                <td>
                                    <div id="tarjeta_dentro">
                                        <h4 align="center">Sistemas Uniandes-Ibarra</h4>
                                    ...
                                    <div id="tarjeta_dentro">
                                        <h4 align="center">rodrigovarela@outlook.es</h4>
                                    </div><br>
                                    <div id="tarjeta_dentro">
                                        <h4 align="center">0998642827</h4>
                                    </div>
                                </td>
                            </tr>
                        </table>
                    ...
                    <%
                        ...
                        if (request.getParameter("buscar") != null) {
                            ...
                            if (b == 1) {
                                ...
                                out.println("<script language='javascript'>window.location='acercade.jsp'</script>;");
