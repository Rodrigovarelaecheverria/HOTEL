        ...
        <div class="about">
            <div class="container">
                 <div style="float: right; width: 1140px;">
                    <a href="../ayudas/ayuda_mision.jsp"><img src="../img/btn_ayuda.png" height="40" width="110" alt=""></a>
                ...
                <div id="centro">
                    ...
                    <div class="about-top heading">
                        <h2 class="tittle-one">MISIÓN Y VISIÓN</h2>
                    ...
                    <%
                        ...
                        if (request.getParameter("buscar") != null) {
                            ...
                            if (b == 1) {
                                ...
                                out.println("<script language='javascript'>window.location='mision.jsp'</script>;");
