        ...
        <div class="about">
            <div class="container">
                ...
                <div id="centro">
                    ...
                    <div class="about-top heading">
                        <h2 class="tittle-one">QUIENES SOMOS</h2>
                    </div>
                    <div class="about-bottom text-center">
                        <img src="../images/g8.jpg" alt="" />
                        <h4>El MEJOR HOTEL DE IBARRA.</h4>
                        <p>Contamos con habitaciones de lujo, TV, telefono, agua caliente, internet inalambrico servicio de bar-restaurant, sala de convenciones con piscina, sauna, turco, hidromasaje y parqueadero privado.</p>
                    </div>
