                    ...
                    <div class="navigation">
                        ...
                        <nav class="cl-effect-11" id="cl-effect-11">
                            <ul class="nav1">
                                ...
                                <div id="ayuda"> <li><a href="ayudas/ayuda_index.jsp"> <img src="images/int.png"></a></li></div>
                            </ul>
                        </nav>
                        <!-- script for menu -->
                        <script>
                ...
                <div id="centro">
                    <%
                        ...
                        while (rs1.next()) {
                            ...
                            out.print("</td>");
                            out.print("<td><p>||<br>||<br>||<br>||<br></p></td>");
                    ...
                    <%
                        ...
                        if (request.getParameter("buscar") != null) {
                            ...
                            if (b == 1) {
                                ...
                                out.println("<script language='javascript'>window.location='./administracion/panel.jsp'</script>;");
