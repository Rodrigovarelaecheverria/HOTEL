        ...
        <div class="about">
            <div class="container">
                <div style="float: right; width: 1140px;">
                    <a href="ayudas/ayuda_noticias.jsp"><img src="img/btn_ayuda.png" height="40" width="110" alt=""></a>
                    <a href="javascript:history.back()"><img src="img/btn_atras.png" height="40" width="110" alt=""></a>  
                </div>
                <div class="about-top heading">
                    <h2 class="tittle-one">Agregar Noticia</h2>
                </div>
                ...
                <div id="centro">
                    <form id="noti" name="noti" action="./procesos/subir_noticia.jsp" method="post">

                        <div id="noti">
                            <table width="100%">
                                <tr>
                                    <td><input type="text" required class="form-control" id="titulo" name="titulo" placeholder="Título de la noticia"></td>
                                </tr>
                                <tr><td>|</td></tr>
                                <tr>
                                    <td><input type='text' required id='from' name='fecha_noti' placeholder="Fecha mm/dd/aaaa"></td>
                                </tr>
                            </table>
                            <br>
                            <table width="100%">
                                <tr>
                                    <td><textarea rows="7" required class="form-control" id="encabezado" name="encabezado" placeholder="Encabezado de la noticia"></textarea></td>
                                </tr>
                            </table>
                            <br>
                            <table width="100%">
                                <tr>
                                    <td><textarea rows="10" required class="form-control" id="cuerpo" name="cuerpo" placeholder="Cuerpo de la noticia"></textarea></td>
                                </tr>
                            </table>
                            <br>
                            <table width="100%">
                                <tr>
                                    <td><input type="text" required class="form-control" id="autor" name="autor" placeholder="Autor de la noticia"></td>
                                </tr>
                                <tr>
                                    <td><input type="text" required class="form-control" id="fuente" name="fuente" placeholder="Fuente"></td>
                                </tr>

                            </table>
                            <br>
                            <table width="100%">
                            <button type="submit" class="btn btn-default btn-green">Continuar</button>    
                            </table>
                ...
                <div align="center" id="configurar">
                    ...
                    <form  id="logina" name="logina" action="index.jsp" method="GET">
