            ...
            <div class="container">
                ...
                <div id="centro">
                    ...
                    <table>
                        <tr>
                            <td>
                               <img src="./img/reporte1.gif" class="img-circle" width="70"><br><br> 
                            </td>
                            <td>
                               <a href="Reportes/habitacionesmasvisitadasd.jsp">► Habitaciones más veces visitadas</a><br><br> 
                        ...
                        <tr>
                            <td>
                               <img src="./img/clmf.jpg" class="img-circle" width="70"><br><br>  
                            </td>
                            <td>
                               <a href="Reportes/clientemasconsumed.jsp">► Clientes que visitan el hotel con más frecuencia</a><br><br> 
                            </td>
                        </tr>
                        <tr>
                            <td>
                               <img src="./img/economico.jpg" class="img-circle" width="70"><br><br>  
                            </td>
                            <td>
                               <a href="Reportes/ingresoseconomicosd.jsp">►Ingresos Economicos</a><br><br> 
                            </td>
                        </tr>
                        <tr>
                            <td>
                               <img src="./img/mesc.jpg" class="img-circle" width="70"><br><br>  
                            </td>
                            <td>
                               <a href="Reportes/mesmasingresoselect.jsp">►Fechas con mayores ingresos </a><br><br> 
                            </td>
                        </tr>
                        <tr>
                            <td>
                               <img src="./img/consumo.jpg" class="img-circle" width="70"><br><br>  
                            </td>
                            <td>
                               <a href="Reportes/fechasdiasver.jsp">►Días de más consumo</a><br><br> 
                            </td>
                        </tr>
                    </table>
