                    ...
                    <div class="about">
                        <div class="container">
                            <div class="about-top heading">
                                  ...
                                  <a class="dropdown-toggle" href="../Reportes/ayuda.jsp?id=/pdf/conoce.pdf">
                                ...
                                <h2 class="tittle-one">Panel de ayuda de Panel de Administración.</h2>
                            </div>
                            <div class="about-bottom text-center">
                                <p>Al dar clic en el panel administración tenemos los siguientes botones disponibles: privilegios, perfiles, reservas, crear noticias, listas, crear usuarios, reportes, añadir reservas, añadir noticias.</p>
