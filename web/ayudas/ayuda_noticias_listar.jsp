                    ...
                    <div class="about">
                        <div class="container">
                            <div class="about-top heading">
                                ...
                                <h2 class="tittle-one">Panel de ayuda de Administracion de noticias.</h2>
                            </div>
                            <div class="about-bottom text-center">
                                
                                <p>Al dar clic en administrar noticias podemos visualizar todas las noticias publicadas en el sistema en donde podemos subir una nueva dando clic en el visto o borrar una noticia dando clic en la equis.<p>
