                    ...
                    <div class="about">
                        <div class="container">
                            <div class="about-top heading">
                                ...
                                <h2 class="tittle-one">Panel de ayuda de Reportes.</h2>
                            </div>
                            <div class="about-bottom text-center">
                                <p>En el panel de reportes podemos escoger entre las siguientes opciones: Habitación mas visitada, Clientes frecuentes, Ingresos económicos por fechas, Fecha con mayores ingresos, Cliente que mas consume.</p>
