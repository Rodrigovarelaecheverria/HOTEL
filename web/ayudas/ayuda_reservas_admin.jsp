                    ...
                    <div class="about">
                        <div class="container">
                            <div class="about-top heading">
                                ...
                                <h2 class="tittle-one">Panel de ayuda de Administración de reservas.</h2>
                            </div>
                            <div class="about-bottom text-center">
                                <p>En el botón administrar reservas podemos subir un voucher, para confirmar el pago de una reserva dando clic en el visto verde, podemos eliminar un voucher dando clic en la equis y podemos realizar una factura dando clic en el botón facturar.</p>
