                    ...
                    <div class="about">
                        <div class="container">
                            <div class="about-top heading">
                                ...
                                <h2 class="tittle-one">Panel de ayuda de Perfiles.</h2>
                            </div>
                            <div class="about-bottom text-center">
                                <p>Al dar click en el botón perfiles podemos realizar una búsqueda de los perfiles activos en el sistema y darles los determinados privilegios disponibles en la parte inferior dando clic en los checkbox.<p>
