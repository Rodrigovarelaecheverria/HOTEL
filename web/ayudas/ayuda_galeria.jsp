                ...
                <div id="centro">
                    <div class="about">
                        <div class="container">
                            ...
                            <a class="dropdown-toggle" href="../Reportes/ayuda.jsp?id=/pdf/galeria.pdf">
                                <img src="../images/icono.png"  width="80" />
                                                            </a>

                                <h2 class="tittle-one">Panel de ayuda Galeria.</h2>
                            </div>
                            <div class="about-bottom text-center">
                                <p>Si presionas sobre el botón de Galería podemos acceder a la Galería fotográfica del hotel.</p>
