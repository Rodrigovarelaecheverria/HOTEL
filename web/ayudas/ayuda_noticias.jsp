                    ...
                    <div class="about">
                        <div class="container">
                            <div class="about-top heading">
                                ...
                                <h2 class="tittle-one">Panel de ayuda de Noticias.</h2>
                            </div>
                            <div class="about-bottom text-center">
                                <p>El formulario de creación de noticias nos permite ingresar título dela noticia, fecha de la publicación, encabezado de la noticia, cuerpo de la noticia, autor de la noticia y fuente, para poder crear la noticia debemos dar clic en el botón continuar.<p>
