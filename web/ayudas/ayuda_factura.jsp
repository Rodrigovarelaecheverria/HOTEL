                    ...
                    <div class="about">
                        <div class="container">
                            <div class="about-top heading">
                                ...
                                <h2 class="tittle-one">Panel de ayuda Factura.</h2>
                            </div>
                            <div class="about-bottom text-center">
                                
                                <p>Al dar clic en el botón facturar podremos visualizar la factura la cual podemos enviarla al correo electrónico del cliente o podemos imprimirla.<p>
