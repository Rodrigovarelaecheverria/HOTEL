                    ...
                    <div class="about">
                        <div class="container">
                            <div class="about-top heading">
                                   <a class="dropdown-toggle" href="../Reportes/ayuda.jsp?id=/pdf/reservar.pdf">
                                <img src="../images/icono.png"  width="80" />
                                                            </a>

                                <h2 class="tittle-one">Panel de ayuda de privilegios.</h2>
                            </div>
                            <div class="about-bottom text-center">
                                <p>Al dar click en el botón de privilegios se nos presenta un formulario en donde tenemos la opción de crear un nuevo registro y concederle los privilegios correspondientes o asignar privilegios a un registro existente mediante una búsqueda por nombre o por código.<p>
                                <img src="../images/v2.png" alt="" />
                                <img src="../images/v3.png" alt="" />
                                <br>
                                <br>
                                <br>
                                <p>Para activar los privilegios que deseamos que esten activos debemos dirigirnos a la parte inferior del formulario en donde se encuentran todos los privilegios a escoger.<p>
