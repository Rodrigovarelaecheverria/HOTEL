                    ...
                    <div class="about">
                        <div class="container">
                            <div class="about-top heading">
                                ...
                                <h2 class="tittle-one">Panel de ayuda Listar.</h2>
                            </div>
                            <div class="about-bottom text-center">
                                <p>En el panel de lista podemos realizar búsquedas de cada uno de los perfiles creados ya sea por DNI, Apellidos o Tipo de perfil.<p>
