                    ...
                    <div class="about">
                        <div class="container">
                            <div class="about-top heading">
                                ...
                                <h2 class="tittle-one">Panel de ayuda Registro de Clientes.</h2>
                            </div>
                            <div class="about-bottom text-center">
                                <p>Para poder registrarse debemos dar click click en el botón Regístrate del panel de Inicio de sesión</p>
