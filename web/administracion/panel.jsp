            ...
            <div class="container">
                ...
                <div align="left" id="reservar">
                    ...
                    <%
                        ...
                        while (me.next()) {%>
                    <div id="reser">
                        <a href="<%out.print(me.getString("referencia"));%>"><%out.print(me.getString("nombre"));%></a>
                    </div>
                    <%
                    ...
                    %>
                    <div id="reser">
                        <a href="<%out.print(mes.getString("referencia"));%>"><%out.print(mes.getString("nombre"));%></a>
                    </div>
                    <%
                            }
                ...
                <div id="centro">
                    <h3 class="tittle-one">PANEL DE ADMINISTRACION</h3>
                    <img src="../images/g1.jpg" width="645px" height="550   px">
                </div>
