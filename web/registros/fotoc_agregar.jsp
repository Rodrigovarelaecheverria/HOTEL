        ...
        <div class="about">
            <div class="container">
                <div class="about-top heading">
                    <h2 class="tittle-one">MODIFICAR CLIENTE</h2>
                </div>
                ...
                <div class="form-group">
                    <%
                        ...
                        while (rs.next()) {
                            ...
                            out.print("<form  id='registro' name='registro' action='../procesos/subir.jsp' method='post'>");
                            out.print("<input type='text' required  class='form-control' id='dni' name='dni' placeholder='Ingrese su DNI' value='" + rs.getString("dni") + "'>");
                            out.print("</div>");
                            out.print("<div class='form-group'>");
                            out.print("<input type='text' disabled class='form-control' id='nombres' name='nombres' placeholder='Ingrese sus nombres' value='" + rs.getString("nombres") + "'>");
                            out.print("</div>");
                            out.print("<div class='form-group'>");
                            out.print("<input type='text' disabled class='form-control' id='apellidos' name='apellidos' placeholder='Ingrese sus apellidos' value='" + rs.getString("apellidos") + "'>");
                            out.print("</div>");
                            out.print("<div style=' text-align:center'><img src='"+(foto)+"' width='250' height='250' alt=''/></div>");
                            out.print("<div class='form-group'>");
                            out.print("<label class='col-sm-2 col-sm-2 control-label'>Imagen de Perfil</label>");
                            out.print("<div class='col-sm-10'>");
                                out.print("<input type='file' class='form-control' name='file' id='file'>");
                            out.print("</div>");
                        out.print("</div>");
                        out.print("<br>");
                        out.print("<button type='submit' class='btn btn-default btn-lg btn-block'>Guardar Imagen</button>");
                        }
                    %>
