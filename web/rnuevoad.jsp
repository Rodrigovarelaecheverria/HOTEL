        ...
        <div class="about">
            <div class="container">
                ...
                <div >
                    ...
                    <form  id="registro" name="registro" action="./procesos/nuevoad.jsp" method="POST">
                        ...
                        <div class="form-group">
                            <input type="text" required class="form-control" id="dni" name="dni" placeholder="Número de Cédula" onchange="evaluar(registro)" onkeydown="return numeros(event)">
                        </div>
                        <div class="form-group">
