...
<%
    ...
    ResultSet rs1 = con.consulta("select * from productos where cod='" + idp + "'");
    String cod = "", det = "", pre = "";
    while (rs1.next()) {
        cod = rs1.getString("cod");
        det = rs1.getString("detalle");
        pre = rs1.getString("precio");
    }
%>
<!DOCTYPE html>
<html>
            ...
            <div class="container">
                ...
                <div id="centro_admin" align="center">
                    <div id="tarjeta" style="display:inline-block;">
                        ...
                        <form  id="m_producto" name="m_producto" action="producto_modificar.jsp" method="POST">
                            <div class="form-group">
                                <input type="text" readonly="" class="form-control" id="codigo" name="codigo" placeholder="Código de producto" value="<%out.print(cod);%>">
                            </div>
                            <div class="form-group">
                                <input type="text" required class="form-control" id="detalle" name="detalle" placeholder="Detalle de producto" value="<%out.print(det);%>">
                            </div>
                            <div class="form-group">
                                <input type="text" required class="form-control" id="precio" name="precio" placeholder="Precio de Producto" onkeydown="return numeros(event)" value="<%out.print(pre);%>">
                            </div>
                            <strong><input type="submit" name="btnmodif" value="MODIFICAR" style="width:100%;"/></strong>
                        </form>
                        <%
                            if (request.getParameter("btnmodif") != null) {
                            String cod1 = request.getParameter("codigo");
                            String det1 = request.getParameter("detalle");
                            String pre1 = request.getParameter("precio");
                            con.consulta("UPDATE productos SET detalle='" + det1 + "', precio='" + pre1 + "' WHERE cod='" + cod1 + "';");
