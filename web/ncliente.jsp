        ...
        <div class="about">
            <div class="container">
                <div class="about-top heading">
                    <h2 class="tittle-one">REGISTRO</h2>
                </div>
                ...
                <div id="centro">
                    <h3 class="tittle-one"> ► ► Registro nuevo cliente</h3>
                    <br>
                    <br>
                    <div >
                        <script type="text/javascript">
                            ...
                            function crearlink(Sel) {
                                if (Sel.tdocumento.options[Sel.tdocumento.selectedIndex].value == "true") {
                                    document.write("<input type='text' required class='form-control' id='dni' name='dni' maxlength='10' placeholder='Número de Cédula' onchange='evaluar(registro)' onkeydown='return numeros(event)'>");
                                }
                            }

                        </script>

                        <form  id="registro" name="registro" action="confirmar.jsp" method="POST">
                            <div class="form-group">
                                <select autofocus required class="form-control" name="tdocumento" id="tdocumento" onchange="crearlink(this.form)">
                                    <option value="true">Nacional</option>
                                    <option value="false">Extranjero</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <input type="text" required class="form-control" id="dni" name="dni" maxlength="10" placeholder="Número de Cédula" onchange="evaluar(registro)" onkeydown="return numeros(event)">
                            </div>
                            <div class="form-group">
                                <input type="text" required class="form-control" id="nombres" name="nombres" placeholder="Nombres" onkeydown="return letras(event);">
                            </div>
                            <div class="form-group">
                                <input type="text" required class="form-control" id="apellidos" name="apellidos" placeholder="Apellidos" onkeydown="return letras(event);">
                            </div>
                            <div class="form-group">
                                <input type="email" class="form-control" id="correo" name="correo" placeholder="Correo electrónico" onchange="return validare(registro);">
                            </div>
                            <div class="form-group">
                                <input name="telefono" type="text" class="form-control" id="telefono" placeholder="Teléfono" onkeydown="return numeros(event)" maxlength="15">
                            </div>
                            <div class="form-group">
                                <input name="celular" type="text" class="form-control" id="celular" placeholder="Teléfono móvil" onkeydown="return numeros(event)" maxlength="15">
                            </div>
                            <div class="form-group">
                ...
                <div align="center" id="configurar">
                    ...
                    <form  name="logina" action="ncliente.jsp" method="GET">
