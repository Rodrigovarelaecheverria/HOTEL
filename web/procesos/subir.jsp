...
<%
    ...
    try {
        ...
        while (iterator.hasNext()) {
            ...
            item.write(file);
            con.consulta("update personas set foto='" + destination + "" + item.getName() + "' where correo='" + user + "'");
            out.println("<script>alert('Foto Actualizada');</script>");
            out.println("<script language='javascript'>window.location='../foto.jsp'</script>;");
        }
