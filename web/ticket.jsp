                ...
                <div id="centro">
                    ...
                    <div align="center" id="ticket">
                        ...
                        <table border=2 width=600>
                            <tr>
                                <td id="titulos_td" align="center" width=100>
                                    PACIENTE
                                </td>
                                <td id="cont_td" width=400>
                                    <% out.print("paciente");%>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <table border=2 width=300>
                            <tr>
                                <td id="titulos_td" align="center" width=150>
                                    TIPO PAGO
                                </td>
                                <td id="cont_td" width=150>
                                    <% out.print("pago");%>
                                </td>
