    ...
    <body>
        ...
        <div class="about">
            <div class="container">
                ...
                <div id="centro">
                    <h3 class="tittle-one">ACTUALIZAR CONTRASEÑA</h3>
                    <br>
                    <br>
                    ...
                    <div>
                        <%
                            ...
                            while (rs.next()) {
                                out.print("<form  id='registro' name='registro' action='clave.jsp?id=" + rs.getString("dni") + "' method='POST'>");

                                out.print("  <div class='form-group'>");
                                out.print(" <input type='password' required class='form-control' id='anterior' name='anterior' placeholder='Contraseña anterior' onchange='valida_pass(this.value, registro)'>");
                                out.print("</div>");

                                out.print("  <div class='form-group'>");
                                out.print(" <input type='password' required class='form-control' id='nueva1' name='nueva1' placeholder='Contraseña nueva' onchange='valida_pass(this.value, registro)'>");
                                out.print("</div>");

                                out.print("  <div class='form-group'>");
                                out.print(" <input type='password' required class='form-control' id='nueva2' name='nueva2' placeholder='Repetir Contraseña' onchange='valida_pass(this.value, registro)'>");
                                out.print("</div>");

                                out.print("  <button name='actualizar' type='submit' class='btn btn-default btn-green'>Actualizar Registro</button>");
                                out.print(" </form>");
                            }
                        %>
                        <%
                ...
                <div align="center" id="configurar">
                    ...
                    <form  id="logina" name="logina" action="clave.jsp" method="GET">
