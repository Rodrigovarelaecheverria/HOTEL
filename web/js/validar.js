...
//Validamos que el digito validador sea igual al de la cedula
                if (digito_validador == ultimo_digito) {
                    ...
                    swal('Cédula Incorrecta', 'Hotel Sierra Norte', 'warning');
...
function validare(forme) {
    ...
    if (!expr.test(email)) {
        swal('Correo Invalido', 'Hotel Sierra Norte', 'warning');
        forme.correo.value = "";
    }
}
...
function valida_pass(tx, forme)
{
    ...
    var t4 = "°!#$%&/()='¿?¡+*-{}[]"
    if (tx.length < 8) {
        swal('Contraseña Incorrecta', 'Su password, debe tener al menos 8 caracteres', 'warning');
        forme.clave.value = "";
    } else
    {
        ...
        if (nMay > 0 && nMin > 0 && nNum > 0 && nEsp > 0) {
            ...
            swal('Contraseña Incorrecta', '*La longitud debe tener mínimo 8 caracteres. \n\
