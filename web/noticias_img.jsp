        ...
        <div class="about">
            <div class="container">
                <div class="about-top heading">
                    <h2 class="tittle-one">Agregar Imágen a Noticia</h2>
                </div>
                ...
                <div id="centro">
                    <form action="./procesos/subir_img_noticia.jsp" enctype="multipart/form-data" method="post">
                        ...
                        <br>
                        <button type="submit" class="btn btn-default btn-lg btn-block">Añadir Imagen</button>
                    </form>
